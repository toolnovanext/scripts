(() => {
    ...
    const renderHeader = () => {
        ...
        const menuItems = [
            ...
            { type: 'link', text: 'Telegram Channel', href: 'https://t.me/shopnotamal' },
            { type: 'link', text: 'YouTube Channel', href: 'https://youtube.com/@accessibleresource?si=jpJqCiNFV2yZL07-' },
